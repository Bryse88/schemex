...
class FoodSpecialtyList extends StatelessWidget {
  FoodSpecialtyList({super.key, required this.businessId});
          ...
          return Center(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Icon(Icons.fastfood, size: 50.sp, color: Colors.grey[700]),
                  SizedBox(height: 10.h),
                  ResuableText(
                    text: 'No specialty food available today',
                        ...
                        return FutureBuilder<List<DocumentSnapshot>>(
                          ...
                          builder: (context, categorySnapshots) {
                            ...
                            return FoodSpecialtyWidget(
                              ...
                              onTap: () {
                                if (userId != null) {
                                  _userDataService.logUserInteraction(
                                    ...
                                    businessId:
                                        businessId, // Make sure this is correct
                                ...
                                safeNavigate(
                                  ...
                                  DrinkDetailsPage(
                                    ...
                                    businessId:
                                        foodData['businessID']
                                            .id, // Use .id to get the string ID
                                  ),
                                );
                              },
                              itemName: foodData['Name'],
                              time: time,
                              businessId:
                                  businessId, // Pass the correct business ID
                            );
                          },
                        );
                      },
